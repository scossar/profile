// Generated on 2014-02-13 using generator-testeleven 0.0.0
'use strict';
...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      jade: {
        files: ['<%= folders.app %>/jade/**/*.jade', 'data/data.js'],
        tasks: ['jade']
      }
    },
    connect: {
    ...
    grunticon: {
      myIcons: {
        files: [{
          expand: true,
          cwd: '<%= folders.app %>/images/svg',
          src: ['*.svg', '*.png'],
          dest: '<%= folders.app %>/images/icons'
        }],
        options: {
